import React, { createRef, Children, cloneElement, Component } from 'react';
...
function (_Component) {
  ...
  function PinchZoom() {
    ...
    _defineProperty(_assertThisInitialized(_this), "_initialOffset", _objectSpread({}, zeroPoint));
    ...
    _defineProperty(_assertThisInitialized(_this), "_offset", _objectSpread({}, zeroPoint));
  ...
  _createClass(PinchZoom, [{
    ...
    value: function _realizeInertia() {
      ...
      if (x || y) {
        ...
        var renderFrame = function renderFrame() {
          ...
          var prevOffset = _objectSpread({}, _this2._offset);
    ...
    value: function _resetOffset() {
      this._offset = _objectSpread({}, this._initialOffset);
    }
  }, {
    key: "_setupOffsets",
    ...
    value: function alignCenter(options) {
      ...
      var _duration$animated$op = _objectSpread({
        duration: 250,
        animated: true
      }, options),
      ...
      var startOffset = _objectSpread({}, this._offset);
      ...
      this._offset = _objectSpread({}, startOffset);
    ...
    value: function scaleTo(options) {
      ...
      var _duration$animated$op2 = _objectSpread({
        duration: 250,
        animated: true
      }, options),
    ...
    value: function _getOffsetTouches(event) {
      ...
      var scrollTop = _html.scrollTop || _body ? _body.scrollTop : 0;
      var scrollLeft = _html.scrollLeft || _body ? _body.scrollLeft : 0;
    ...
    value: function _animate(frameFn, options) {
      ...
      var _timeFn$callback$dura = _objectSpread({
        timeFn: swing,
        callback: function callback() {},
...
export { hasTranslate3DSupport, isTouch, make2dTransformValue, make3dTransformValue };
